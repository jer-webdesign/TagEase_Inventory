...
try {
    scp "$SourceDir\app.py" "${PiUser}@${PiIP}:/home/${PiUser}/rfid_tracker/"
...
try {
    scp "$SourceDir\rfid-tracker.service" "${PiUser}@${PiIP}:/home/${PiUser}/"
    Write-Host "Successfully transferred service file" -ForegroundColor Green
} catch {
...
try {
    scp "$SourceDir\deploy_pi.sh" "${PiUser}@${PiIP}:/home/${PiUser}/"
    Write-Host "Successfully transferred deployment script" -ForegroundColor Green
} catch {
...
try {
    scp "$SourceDir\RASPBERRY_PI_DEPLOYMENT.md" "${PiUser}@${PiIP}:/home/${PiUser}/"
    scp "$SourceDir\SERVICE_QUICK_REFERENCE.md" "${PiUser}@${PiIP}:/home/${PiUser}/"
    scp "$SourceDir\WEBSOCKET_IMPLEMENTATION.md" "${PiUser}@${PiIP}:/home/${PiUser}/"
...
Write-Host "   chmod +x /home/${PiUser}/deploy_pi.sh" -ForegroundColor Gray
Write-Host "   sudo bash /home/${PiUser}/deploy_pi.sh" -ForegroundColor Gray
Write-Host ""
